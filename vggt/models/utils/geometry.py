...
from vggt.models.dependency.distortion import apply_distortion, iterative_undistortion, single_undistortion
...
#     depth_map: np.ndarray, extrinsics_cam: np.ndarray, intrinsics_cam: np.ndarray, pixel_convention: str = "colmap"
# ) -> np.ndarray:
#     """
...
#             depth_map[frame_idx].squeeze(-1), extrinsics_cam[frame_idx], intrinsics_cam[frame_idx], pixel_convention=pixel_convention
#         )
...
#     cam_coords_points = depth_to_cam_coords_points(depth_map, intrinsic, pixel_convention=pixel_convention)
...
# def depth_to_cam_coords_points(depth_map: np.ndarray, intrinsic: np.ndarray, pixel_convention: str = "colmap") -> tuple[np.ndarray, np.ndarray]:
#     """
