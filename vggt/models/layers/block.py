...
class SelfAttentionBlock(nn.Module):
    ...
    def _forward(self, x: Tensor, rope=None) -> Tensor:
        ...
        if self.training and self.sample_drop_ratio > 0.0:
            raise ValueError("sample_drop_ratio > 0.0 is not supported")
...
class CausalSelfAttentionBlock(nn.Module):
    def __init__(
        ...
        self.attention = CausalSelfAttention(dim, num_heads, attn_drop=dropout_prob, proj_drop=dropout_prob, use_qk_norm=use_qk_norm, use_flash_attn=use_flash_attn)
